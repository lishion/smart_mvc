...
public class UrlUtil {
    ...
    final static String classPath = ClassUtil.getClassPath();
     ...
     */
    public List<String> getAllClassName(List<String> packages){
     ...
     * @return 转换后的文件目录
     */
    private  String convertPackageToUrl(String topPackageName){
     ...
     * @return 包名+类名
     */
    private String convertUrlToPackage(String url){
     ...
     * @throws IOException
     */
    private List<String> getFilesName(String url,Predicate<Path> filter) throws IOException{
